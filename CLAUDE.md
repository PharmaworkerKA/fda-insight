# FDA規制インサイト - スケジュールエージェントガイド

このリポジトリは **FDA規制・ガイダンス** の実務情報を発信するブログ `FDA規制インサイト` の本体です。
あなた（スケジュールエージェント）は毎日JST 03:40に起動し、最新ネタをリサーチして記事を **2本** 生成します。

## 1日のタスク

1. **リサーチ**: WebSearch / WebFetch で FDA NDA/BLA/IND/Warning Letter/PMDA-FDA比較 に関する最新トピック2件を収集
   - 候補例: FDA Warning Letter 最新分析／510(k) と De Novo の違い／FDAガイダンス草案の重要ポイント／Complete Response Letter 対応戦略／FDA-PMDA 申請データ要件比較
...
<title>{{記事タイトル}} | FDA規制インサイト</title>
<meta name="description" content="{{150字以内の要約}}">
<link rel="canonical" href="https://pharmaworkerka.github.io/fda-insight/articles/{{slug}}.html">
<meta property="og:type" content="article">
<meta property="og:title" content="{{タイトル}}">
<meta property="og:description" content="{{要約}}">
<meta property="og:image" content="{{Unsplash画像URL}}">
<meta property="og:url" content="https://pharmaworkerka.github.io/fda-insight/articles/{{slug}}.html">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="{{Unsplash画像URL}}">
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Article","headline":"{{タイトル}}","image":"{{Unsplash}}","datePublished":"{{YYYY-MM-DD}}","author":{{"@type":"Organization","name":"FDA規制インサイト"}}}}</script>
...
<p class="copyright">© 2026 FDA規制インサイト</p>
</div></footer>
</body></html>
```
...
```xml
<url>
  <loc>https://pharmaworkerka.github.io/fda-insight/articles/{{slug}}.html</loc>
  <lastmod>{{今日}}</lastmod>
